...
async function CFcheckToken(tokensObject = null, config = defaults) {
  ...
  for (var token in tokens) {
    var options = {
      ...
      headers: {
        'Authorization': request.authorizationPrefix + tokens[token],
...
exports.checkToken = CFcheckToken;

exports.listZones = CFlistZones;
exports.getZoneId = CFgetZoneId;

exports.listDNS = CFlistDNS;
exports.getDNSId = CFgetDNSId;
exports.getDNSIp = CFgetDNSIp;
exports.updateDNSRecord = CFupdateDNSRecord;
